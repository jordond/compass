...
public interface PlatformGeocoder {
    ...
    public companion object {
        ...
        private var _instance: PlatformGeocoder? = null

        /**
         * Get the singleton instance of the [PlatformGeocoder].
         */
        public fun getInstance(): PlatformGeocoder {
            return _instance ?: createPlatformGeocoder().also { _instance = it }
        }
    }
}
